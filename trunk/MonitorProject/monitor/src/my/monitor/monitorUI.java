...
public class monitorUI extends javax.swing.JFrame {
    ...
    static int VIDEO_WAIT = 0;
    static int VIDEO_RUNNING = 1;
    int video_status;
    ...
    private void initComponents() {
        ...
        jButton4.setFont(new java.awt.Font("Liberation Sans", 0, 12));
        ...
        jButton9.setFont(new java.awt.Font("Liberation Sans", 0, 12));
        ...
        jTextPort.setFont(new java.awt.Font("Liberation Sans", 0, 12)); // NOI18N
    ...
    private void jButton9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton9MouseClicked
        if (!status.equals("Connected")) {
            ...
            if (video_status == VIDEO_WAIT) {
                video_status = VIDEO_RUNNING;
                jButton9.setText("Robot running >> stop");
            } else {
                video_status = VIDEO_WAIT;
                jButton9.setText("start");
            }
