...
#define DDR_MOTOR_LEFT_REVERSE		DDRB
#define PORT_MOTOR_LEFT_REVERSE		PORTB
#define PIN_MOTOR_LEFT_REVERSE		PINB
#define MOTOR_LEFT_REVERSE_PIN_NBR	3

#define DDR_MOTOR_LEFT_FORWARD		DDRD
#define PORT_MOTOR_LEFT_FORWARD		PORTD
#define PIN_MOTOR_LEFT_FORWARD		PIND
